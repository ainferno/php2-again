...
<div class="container">
    <?php foreach($this->news as $article) { ?>
        <div class="card">
            <a href="article.php?ctrl=User&action=One&id=<?php echo $article->id; ?>"><div class="card-header"><?php echo $article->Name; ?></div></a>
...
<form action="index.php?ctrl=User&action=Append" method="post"> 
